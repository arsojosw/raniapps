          ...
          return (
            <TouchableOpacity
              ...
              <View
                ...
                <Icon name={item.icon} size={18} color={colors.primary} solid type={'font-awesome-5'} />
              </View>
            ...
            <FlatList
              ...
              renderItem={({item, index}) => (
                <Card
                  ...
                  <View >
                    <Text title2 whiteColor semibold style={[styles.textWithShadow]}>
                      {item.title2}
                    </Text>
